...
## Create a record {{ tag: 'POST', label: 'https://iwdr.org/iwdr/api/v1.php?table=tblDogStatusHistoryAPI&action=insert' }}

<Row>
    <Col>
        Insert a new status history record for a given dog.
    </Col>
    <Col sticky>
