...
## Create a record {{ tag: 'POST', label: 'https://iwdr.org/iwdr/api/v1.php?table=VetLab&action=insert' }}

<Row>
    <Col>
        Insert a vet lab record for your organization.
    </Col>
    <Col sticky>
        ...
        <CodeGroup title="Response">
            ```json
            {
                ...
                "act_LastUpdated": "2023-06-22 15:41:55",
...
## List records {{ tag: 'GET', label: 'https://iwdr.org/iwdr/api/v1.php?table=VetLab&action=list' }}

<Row>
    <Col>
        List all vet lab records for your organization.
