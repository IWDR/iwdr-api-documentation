...
## Create a record {{ tag: 'POST', label: 'https://iwdr.org/iwdr/api/v1.php?table=VetVaccines&action=insert' }}

<Row>
    <Col>
        Insert a new vaccination record for your organization.
    </Col>
    <Col sticky>
        ...
        <CodeGroup title="Response">
            ```json
            {
                ...
                "act_LastUpdated": "2023-06-22 15:36:47",
...
## List records {{ tag: 'GET', label: 'https://iwdr.org/iwdr/api/v1.php?table=VetVaccines&action=list' }}

<Row>
    <Col>
        List all vaccination records for dogs owned by your organization.
    ...
    <Col sticky>
        <CodeGroup title="Response">
                ...
                "data": [
            {
                ...
                "act_UserEntering": "1234",
                "act_LastUpdated": "2022-02-24 15:26:14",
                "act_DaysDueAgain": null,
                "act_AgeYrs": "6.5833333333333",
                "act_LastActID": null
            },
            {
                ...
