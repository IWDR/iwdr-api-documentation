...
## Create a record {{ tag: 'POST', label: 'https://iwdr.org/iwdr/api/v1.php?table=HeatsWhelpsChildTbl&action=insert' }}

<Row>
    <Col>
        Insert a new estrus record for a given dog.
    </Col>
    <Col sticky>
        ...
        <CodeGroup title="Response">
            ```json
            {
                ...
                "lit_DamID": "1234",
                "lit_Comments": "Test data",
                "lit_LastUpdated": "2023-06-21 12:11:07",
...
## List records {{ tag: 'GET', label: 'https://iwdr.org/iwdr/api/v1.php?table=HeatsWhelpsChildTbl&action=list' }}

<Row>
    <Col>
        List all estrus records for dogs owned by your organization.
