...
This table shows an example mapping row, from the IWDR interface,
...
<Note>
    **Note**: Not all mapping records need to populated. You only need to supply a mapping for values which apply to
