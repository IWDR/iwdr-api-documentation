                    ...
                    <div className="inline-block min-w-full py-2 align-middle md:px-6 lg:px-8 ">
                        <div
                            className={clsx(
                                ...
                                'rounded-t-md bg-slate-100 shadow-md ring-1 ring-black ring-opacity-5 dark:bg-zinc-800',
                                item_data?.length === 0 && 'rounded-b-lg'
                            )}
                        >
                            {searchable && (
                                <form
                                    className="flex w-full flex-row items-end justify-between border-b border-gray-300 px-4 py-4 dark:border-zinc-600"
                                ...
                                >
                                    {item_data?.length > 0 ? (
                                        ...
                                        <tr>
                                            ...
                                            >
                                                {isLoading && <Spinner className="mx-auto my-2 h-10 w-10" />}
