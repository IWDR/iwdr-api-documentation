        ...
        <>
            <Listbox value={value} onChange={onChange} id={id} multiple={multiple && options}>
                {({ open }) => (
                    ...
                    >
                        <div>
                            <Listbox.Label className="block text-sm font-semibold leading-6 text-zinc-900 dark:text-white">
                                {label}
                        ...
                        <div className="not-prose relative mt-2 block max-w-lg sm:mt-0">
                            <Listbox.Button
                                className={clsx(
                                    ...
                                    'relative flex w-full cursor-default rounded-md border py-3 pl-3 pr-10 text-left shadow-sm dark:bg-zinc-900 sm:text-sm'
                                )}
                            >
                                <span className="block truncate whitespace-normal">
                                    {value.length > 0 || typeof value === 'number' ? (
                                        typeof value.map !== 'undefined' ? (
                                            ...
                                            <span>{getTextFromVal(value)}</span>
                                        )
                                    ) : (
