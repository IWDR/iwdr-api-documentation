...
const resources = [
    {
        ...
        description:
            'Learn about the behavior checklist model and how to create, retrieve, update, and list, the behavior checklists for your owned dogs.',
        icon: ClipboardIcon,
        pattern: {
            y: 1,
            squares: [
    ...
    },
    {
        ...
        name: 'Procedures',
        description:
            'Learn about the procedures model and how to create, retrieve, update, and list, the procedures for your owned dogs.',
        icon: BeakerIcon,
        patter: {
            y: 7,
            squares: [[0, 1]],
