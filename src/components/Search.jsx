    ...
    return (
        <div className="group relative flex h-12">
            ...
            <input
                ref={inputRef}
                className={clsx(
                    'flex-auto bg-transparent rounded-lg border-transparent focus:border-emerald-300 pl-10 text-zinc-900 placeholder:text-gray-400 dark:text-white sm:text-sm',
        ...
        >
            ...
            >
                ...
                <div className="fixed inset-0 overflow-y-auto px-4 py-4 sm:py-20 sm:px-6 md:py-32 lg:px-8 lg:py-[15vh]">
                    ...
                    >
                        <Dialog.Panel
                            className="mx-auto overflow-hidden rounded-lg bg-zinc-50 dark:bg-zinc-900 dark:ring-zinc-800 sm:max-w-xl">
